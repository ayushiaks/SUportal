		...
		<div class="row">
			...
			<h4>Register Complaint</h4>
				<div class="div">
					...
					<div class="input-field col s12">	
						<input placeholder="Email" type="hidden" name="email" value="<?php echo $email;?>">
					</div>
					<div class="input-field col s12">	
					...
					<div class="input-field col s12">	
						<textarea class="materialize-textarea" name="message" placeholder="Type Your Complaint Here" required></textarea>
					</div>	
